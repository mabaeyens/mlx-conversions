...
- `14B-bf16` reproducibly fails functional (generation) verification on this 32GB
  ...
  way to confirm it on this hardware. Local copy (~26GB) removed once safely
  uploaded, since the failure is a confirmed hardware ceiling rather than
  something a kept-around local copy would help debug.
